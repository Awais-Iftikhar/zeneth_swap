...
const ERC20Form = () => {
  ...
  const doSubmit = async (e: React.FormEvent) => {
    ...
    console.log(swapBriberContract);
    
    console.log('env key',process.env.AUTH_PRIVATE_KEY);
    debugger
    ...
    console.log('gas limit',hexlify(token.gasEstimates.transfer));
    console.log(ethers.utils.parseUnits('1000', 'gwei'),);
